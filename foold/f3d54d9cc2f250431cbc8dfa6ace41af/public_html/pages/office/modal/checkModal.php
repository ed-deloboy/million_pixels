        ...
        <div class="p-1 text-center">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <p class="mb-0"><?= $trans['details'] ?></p>
                    <p class="mb-0">Торговый счет: <?= $trans['Account'] ?></p>
                    <img class="w-100" src="/assets/img/order/<?= $trans['transaction_id']  ?>.<?= $f ?>">
                </div>
            </div>
        </div>
    </div>
